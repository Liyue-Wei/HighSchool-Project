...
class GUI_interface:
    ...
    tk.Button(win, text="Delete", font=("微軟正黑體", 13)).place(x=1116, y=261, width=154, height=62)
    ...
    tk.Button(win, text="Download List", font=("微軟正黑體", 13)).place(x=15, y=645, width=168, height=62)
    tk.Button(win, text="Information", font=("微軟正黑體", 13)).place(x=195, y=645, width=154, height=62)
    tk.Button(win, text="Error List", font=("微軟正黑體", 13)).place(x=360, y=645, width=154, height=62)
