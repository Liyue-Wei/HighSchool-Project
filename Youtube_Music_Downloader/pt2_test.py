...
class GUI_interface:
    ...
    tk.Radiobutton(win, text="由網址刪除", font=("微軟正黑體", 11), value="1080p").place(x=713, y=340)
    tk.Radiobutton(win, text="由歌名刪除", font=("微軟正黑體", 11), value="1080p").place(x=884, y=340)
    tk.Radiobutton(win, text="由錯誤自動刪除", font=("微軟正黑體", 11), value="1080p").place(x=1055, y=340)
    ttk.Entry(win, font=("微軟正黑體", 16), width=26).place(x=10, y=265)
    ttk.Entry(win, font=("微軟正黑體", 16), width=20).place(x=713, y=265)
