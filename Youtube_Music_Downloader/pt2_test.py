...
class GUI_interface:
    ...
    tk.Button(win, text="Search", font=("微軟正黑體", 13), command=search).place(x=1116, y=131, width=154, height=62)
    ttk.Label(win, text="詳細資訊", font=("微軟正黑體", 14)).place(x=10, y=225)
    ttk.Frame(win, height=5, width=1260, style="darkly").place(x=10, y=270)
    tk.Button(win, text="Download", font=("微軟正黑體", 13), command=video_download).place(x=1116, y=290, width=148, height=288)
