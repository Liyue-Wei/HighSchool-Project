...
class GUI_interface():
    ...
    entry_1 = ttk.Entry(win, width=38, bootstyle="cosmo", font=("微軟正黑體", 20), textvariable=dna_input).place(x=10, y=90)
    ...
    button_1 = tk.Button(win, text="Enter", font=("微軟正黑體", 14), command=translation).place(x=1100, y=90)
