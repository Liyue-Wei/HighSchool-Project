...
class GUI_interface():
    ...
    tk.Text(win, font=("微軟正黑體", 12)).place(x=5, y=245, width=590, height=400)
    tk.Button(win, text="smtp/tcp settings", font=("微軟正黑體", 14)).place(x=5, y=650)
    tk.Button(win, text="send", font=("微軟正黑體", 14)).place(x=530, y=650)
